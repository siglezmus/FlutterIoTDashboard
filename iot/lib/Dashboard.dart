...
class _DashboardState extends State<Dashboard>
  ...
  void initState() {
    ...
    databaseReference.child('Live').once().then((DataSnapshot snapshot) {
      double temp = snapshot.value['Temperature']['Data'].toDouble();
      double humidity = snapshot.value['Humidity']['Data'].toDouble();
  ...
  handleLoginOutPopup() {
    Alert(
      ...
      type: AlertType.info,
      title: "Log Out",
      desc: "Do you want to log out now?",
      buttons: [
        DialogButton(
          child: Text(
            "No",
